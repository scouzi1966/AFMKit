...
public struct VisionRequestOptions: Sendable {
    ...
    public let recognitionLevel: VisionRecognitionLevel
...
public struct BarcodeResult: Sendable {
    ...
    public init(type: String, payload: String, boundingBox: CGRect, confidence: Float) {
        self.type = type
...
public struct ClassifyResult: Sendable {
    ...
    public init(labels: [ClassificationLabel], salientRegions: [CGRect]) {
        self.labels = labels
...
public struct SaliencyRegion: Sendable {
    ...
    public init(type: String, boundingBox: CGRect) {
        self.type = type
        self.boundingBox = boundingBox
    }
}
...
public struct SaliencyResult: Sendable {
    ...
    public init(regions: [SaliencyRegion], heatMapPNG: Data?) {
        self.regions = regions
        self.heatMapPNG = heatMapPNG
    }
}

// MARK: - VisionService (no class-level macOS restriction)

public final class VisionService: Sendable {
    public init() {}
...
public struct VisionDocumentResult: Sendable {
    public let filePath: String
    public let fullText: String
    public let pages: [VisionPageResult]
    public let documentHints: [String]

    public init(filePath: String, fullText: String, pages: [VisionPageResult], documentHints: [String]) {
...
public struct VisionPageResult: Sendable {
...
public struct TextBlock: Sendable {
    ...
    public init(text: String, confidence: Float, boundingBox: CGRect, pageNumber: Int = 1) {
        self.text = text
        self.confidence = confidence
        self.boundingBox = boundingBox
        self.pageNumber = pageNumber
...
public struct PositionedTextBlock: Sendable {
    public let text: String
    public let confidence: Float
    public let boundingBox: CGRect
    public let pageNumber: Int
