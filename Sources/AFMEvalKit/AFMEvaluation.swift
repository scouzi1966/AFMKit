...
public enum AFMEvaluationError: LocalizedError, Sendable {
...
public enum AFMEvaluationRunPolicy {
    ...
    public static func validatePlannedOutput(
    ...
    public static func shouldWriteSnapshot(
        completedCases: Int,
        lastSnapshotAt: Date?,
        now: Date
    ) -> Bool {
...
public enum AFMEvaluationValidator {
    public static let maximumSuiteBytes = 5_000_000

    public static func decode(
        _ data: Data,
        allowsCrossCaseMatching: Bool = false,
        source: String? = nil
    ) throws -> AFMEvaluationSuite {
        guard data.count <= maximumSuiteBytes else {
        ...
        do {
            ...
            throw AFMEvaluationError.invalidSuite("\(prefix)\(error.localizedDescription)")
        }
    }
    ...
    public static func validateSafeName(_ value: String, field: String) throws {
