...
public final class SpeechSynthesisService: NSObject, @unchecked Sendable {
    ...
    public func synthesize(text: String, options: TTSRequestOptions) async throws -> Data {
        ...
        let synthesizer = UncheckedSendable(AVSpeechSynthesizer())
        let utteranceBox = UncheckedSendable(utterance)
            ...
            group.addTask {
                ...
                return try await withTaskCancellationHandler {
                    try await withCheckedThrowingContinuation { continuation in
                        ...
                        synthesizer.value.write(utteranceBox.value) { buffer in
