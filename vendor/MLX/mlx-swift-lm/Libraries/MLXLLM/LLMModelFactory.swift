...
public enum LLMTypeRegistry {
    ...
    public static let shared: ModelTypeRegistry = .init(creators: [
        ...
        "glm5_next": create(GLM5NextConfiguration.self, GLM5NextModel.init),
        "glm5_next_text": create(GLM5NextConfiguration.self, GLM5NextModel.init),
...
public final class LLMModelFactory: ModelFactory {
    ...
    public func _load(
        ...
        try (model as? Qwen4ExpModel)?.applyMappedNGramResidency(
