...
updated 2026-09-03. The implementation merged by AFMKit PR #75 now meets the
...
prefill optimization is deliberately deferred.
...
- The merged default path reaches **905.9/68.50 tok/s** at 0.5K and
  **1285.1/59.98 tok/s** at 4K in the latest same-checkpoint comparison. AFM is
  no more than 1.88% slower at any measured point, exceeds the reference decode
  rate at every context size, and its saved responses are coherent.
