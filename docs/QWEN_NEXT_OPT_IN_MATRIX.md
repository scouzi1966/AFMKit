...
| N8 retained lifecycle | Frozen default-normalization binary, M25/C15/prefix; long mixed-lane prompts and request identities | 665/665 assertions, 182 shared-verification batches, cancellation recovery/full replay, clean exit | Measured; actual model A→B→A remains untested; [report](QWEN_NEXT_RETAINED_QUALIFICATION.md) |
