...
case "$MODULE" in
    AFMKitCore|AFMOpenAICompat|AFMKitInference|AFMKitApple|AFMKitEmbeddings|AFMKitSpeech|AFMKitSpeechSynthesis|AFMKitVision|AFMKitServices|AFMEvalKit|AFMKitDwarfStar|AFMKitFoundationModelsDwarfStar|AFMKitMLX|AFMKitMLXAudio|AFMKitMLXImage|AFMKitFoundationModelsMLX)
        PACKAGE_ROOT="$ROOT"
