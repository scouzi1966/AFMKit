...
case "$MODULE" in
    AFMKitSplash|AFMKitCore|AFMOpenAICompat|AFMKitInference|AFMKitApple|AFMKitEmbeddings|AFMKitSpeech|AFMKitSpeechSynthesis|AFMKitVision|AFMKitServices|AFMEvalKit|AFMKitDwarfStar|AFMKitFoundationModelsDwarfStar|AFMKitMLX|AFMKitMLXAudio|AFMKitMLXImage|AFMKitFoundationModelsMLX)
        PACKAGE_ROOT="$ROOT"
...
case "$MODULE" in
    AFMKitMLX|AFMKitMLXAudio|AFMKitMLXImage|AFMKitFoundationModelsMLX)
