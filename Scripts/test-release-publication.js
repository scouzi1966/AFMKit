        ...
        rest: {
            ...
            repos: {
                ...
                async createRelease() {
                    ...
                    state.release = { id: 7, tag_name: "v1.2.3" };
...
async function run() {
    ...
    assert.deepEqual(fixture.state.calls, { createTag: 1, createRef: 1, createRelease: 1 });
    ...
    console.log("8 release publication regression scenarios passed.");
}
