...
if [[ "$TOTAL_PRODUCT_COUNT" != "14" ]]; then
    echo "Downstream qualification built $TOTAL_PRODUCT_COUNT products; expected 14." >&2
    exit 1
fi
...
echo "AFMKit downstream staging mirrors built all fourteen public products from fresh graphs."
