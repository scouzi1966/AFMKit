...
expected = {
    "xcode26": {"AFMKitSplash", "AFMKitCore", "AFMOpenAICompat", "AFMKitInference", "AFMKitEmbeddings", "AFMKitSpeech", "AFMKitSpeechSynthesis", "AFMKitVision", "AFMKitServices", "AFMEvalKit", "AFMKitDwarfStar", "AFMKitMLX", "AFMKitMLXAudio", "AFMKitMLXImage"},
    "xcode27": {"AFMKitSplash", "AFMKitCore", "AFMOpenAICompat", "AFMKitInference", "AFMKitEmbeddings", "AFMKitSpeech", "AFMKitSpeechSynthesis", "AFMKitVision", "AFMKitServices", "AFMEvalKit", "AFMKitApple", "AFMKitDwarfStar", "AFMKitFoundationModelsDwarfStar", "AFMKitMLX", "AFMKitMLXAudio", "AFMKitMLXImage", "AFMKitFoundationModelsMLX"},
}[mode]
