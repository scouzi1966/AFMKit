...
package struct AFMDwarfStarGenerationResult: Sendable {
    package var text: String
    package var reasoning: String?
    package var usage: AFMUsage
    package var toolCalls: [AFMToolCall]
    package var finishReason: AFMFinishReason
    package var metadata: [String: AFMJSONValue]

    package func response(modelID: String) -> AFMModelResponse {
