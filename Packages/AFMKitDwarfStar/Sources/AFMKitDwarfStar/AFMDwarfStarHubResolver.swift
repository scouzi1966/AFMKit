...
package struct AFMDwarfStarHubArtifact: Equatable, Sendable {
    ...
    package init(path: String, size: Int64?) {
        self.path = path
        self.size = size
...
package enum AFMDwarfStarHubSelector {
    package static func selectModel(
