...
public enum AFMMLXMediaSecurityPolicy {
    ...
    private static func isPublicIPAddress(_ address: String) -> Bool {
        ...
        // Conservatively reject IANA special-purpose ranges inside 2000::/3.
        // 2001::/23 contains transition, benchmarking, ORCHID, and other
        // non-forwardable assignments; 2002::/16 is 6to4 and embeds an IPv4
        // endpoint that must not bypass the IPv4 policy.
