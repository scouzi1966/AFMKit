...
| [0006](0006-package-boundary-provider-publication.md) | Superseded by 0007 | Publish dependency-free and runtime products through separate package boundaries. |
| [0007](0007-single-repository-package.md) | Accepted | Publish all AFMKit products from one repository, manifest, lock, and tag. |
